...
PUT file:///home/andi-ml/Documents/projects/UD-DA-Module-2/UD-DA-How-Weather-affects-Restaurant-Ratings/data/yelp_data/yelp_dataset/yelp_academic_dataset_checkin.json @sf_tut_stage;
...
COPY INTO yelp_checkin(business_id, date)
    FROM (SELECT parse_json($1):business_id,
                 parse_json($1):date
          FROM @sf_tut_stage/yelp_academic_dataset_checkin.json.gz t)
    ON_ERROR = 'continue';
