...
COPY INTO yelp_business(business_id, name, address, city, state, postal_code, latitude, longitude, stars,
    ...
    FROM (SELECT parse_json($1):business_id,
                 ...
                 parse_json($1):attributes.attributes_CoatCheck,
                 parse_json($1):attributes.attributes_DriveThru,
                 parse_json($1):attributes.attributes_Smoking,
                 parse_json($1):attributes.attributes_BYOB,
                 parse_json($1):attributes.attributes_Corkage,
